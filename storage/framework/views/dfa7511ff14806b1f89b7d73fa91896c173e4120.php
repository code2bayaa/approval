    ...
    <div class="content content-boxed">
        <div class="row">
            <div class="col-md-12 col-xl-12">
                <!-- Updates -->
                <form class="js-validation-signin" method="post" action="<?php echo e(route('application.save')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                                ...
                                <div class="row" style="padding: 5px !important;">
                                    ...
                                    <div class="col-sm-8 text-uppercase" style="padding: 5px !important;">
                                        <select name="school" class="form-control form-control-alt text-uppercase">
                                            <option value="<?php echo e($course->school_id); ?>" selected><?php echo e($course->school_id); ?></option>
                                ...
                                <div class="row" style="padding: 5px !important;">
                                    ...
                                    <div class="col-sm-8 text-uppercase" style="padding: 5px !important;">
                                        <select name="department" class="form-control form-control-alt text-uppercase">
                                            <option value="<?php echo e($course->department_id); ?>" selected><?php echo e($course->department_id); ?></option>
                                ...
                                <div class="row" style="padding: 5px !important;">
                                    ...
                                    <div class="col-sm-8 text-uppercase" style="padding: 5px !important;">
                                        <select name="course" class="form-control form-control-alt text-uppercase">
                                            <option value="<?php echo e($course->course_name); ?>" selected><?php echo e($course->course_name); ?></option>
...
<<<<<<< HEAD
                                ...
                                <div class="row" style="padding: 5px !important;">
                                    ...
                                    <div class="col-sm-8 text-uppercase" style="padding: 5px !important;">
<<<<<<< HEAD
                                        <input name="campus" class="form-control form-control-alt" readonly value="<?php echo e($course->campus); ?>">
=======
                            ...
                            <div class="block-content block-content-full">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8" style="padding: 10px !important;">
                                        ...
                                        <input type="text" class="form-control form-control-alt text-uppercase" value="<?php echo e(old('primary')); ?>" name="primary" placeholder="Institution name">
                                        </div>
                                        <div style="padding: 7px !important;">
                                        <input type="text" class="form-control form-control-alt text-uppercase" value="<?php echo e(old('primaryqualification')); ?>" name="primaryqualification" placeholder="Qualifications acquired">
                                        </div>
                                        <div class="row" style="padding: 7px !important;">
                                            <div class="col-6">
                                                <input type="month" class="form-control form-control-alt" value="<?php echo e(old('pristartdate')); ?>" name="pristartdate">
                                                <small class="text-muted">Starting year</small>
                                            </div>
                                            <div class="col-6">
                                                <input type="month" class="form-control form-control-alt" value="<?php echo e(old('prienddate')); ?>" name="prienddate">
                                                <small class="text-muted">Year Finished</small>
                                            </div>
                                        </div><div style="padding: 7px !important;">
                                        <input type="file" class="form-control form-control-alt" value="<?php echo e(old('primarycert')); ?>" name="primarycert" placeholder="upload certificate">
                        ...
                        <div class="timeline-event-block block">
                            ...
                            <div class="block-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="text-uppercase" style="padding: 7px !important;">
                                            <input type="text" class="form-control form-control-alt text-uppercase" value="<?php echo e(old('sponsorname')); ?>" name="sponsorname" placeholder="Sponsor name">
                                        </div>
                                        <div class="text-uppercase" style="padding: 7px !important;">
                                            <input type="text" class="form-control form-control-alt text-uppercase" value="<?php echo e(old('sponsormobile')); ?>" name="sponsormobile" placeholder="Sponsor mobile number">
                                        </div>
                                        <div class="text-uppercase" style="padding: 7px !important;">
...
<?php echo $__env->make('application::layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\TUM\Modules/Application\Resources/views/applicant/application.blade.php ENDPATH**/ ?>